        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlindBoxTier = table.Column<int>(type: "int", nullable: true),
                    ...
                    ApprovedPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    RefundInfo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BuybackRequests_AspNetUsers_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardTemplate = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonateRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DonateRequests_AspNetUsers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ImportTickets_AspNetUsers_StaffId",
                        column: x => x.StaffId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserReadLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserReadLogs_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    ImportTicketId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Accessories_ImportTickets_ImportTicketId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Books_ImportTickets_ImportTicketId",
                        column: x => x.ImportTicketId,
                        principalTable: "ImportTickets",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlindBoxTier = table.Column<int>(type: "int", nullable: true),
                    BlindBoxGenre = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Quantity = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderItems", x => new { x.OrderId, x.BookId, x.AccessoryId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accessories_ImportTicketId",
                table: "Accessories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_ImportTicketId",
                table: "Books",
                column: "ImportTicketId");

            migrationBuilder.CreateIndex(
                name: "IX_BuybackRequests_CustomerId",
                table: "BuybackRequests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_BuybackRequests_RequestCode",
                table: "BuybackRequests",
                column: "RequestCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DonateRequests_CustomerId",
                table: "DonateRequests",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_ImportTickets_StaffId",
                table: "ImportTickets",
                column: "StaffId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItems_CustomerId_BookId_AccessoryId",
                table: "ShoppingCartItems",
                columns: new[] { "CustomerId", "BookId", "AccessoryId" },
                unique: true,
                filter: "[BookId] IS NOT NULL AND [AccessoryId] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_UserReadLogs_UserId",
                table: "UserReadLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItems_CustomerId_BookId_AccessoryId",
                table: "WishlistItems",
                columns: new[] { "CustomerId", "BookId", "AccessoryId" },
                unique: true,
                filter: "[BookId] IS NOT NULL AND [AccessoryId] IS NOT NULL");
